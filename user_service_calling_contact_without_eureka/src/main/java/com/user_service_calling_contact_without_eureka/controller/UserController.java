...
import com.user_service_calling_contact_without_eureka.service.ContactService;
...
public class UserController {
	...
	public User getUser(@PathVariable("userId") Long userId) {
		...
		if (listContact == null) {
			...
			System.out.println("Calling contact service getContactsOfUser(userId)...");

			listContact = contactService.getContactsOfUser(userId);
