package com.user_service_calling_contact_with_eureka_circuitbreaker_feignclient.controller;
...
import com.user_service_calling_contact_with_eureka_circuitbreaker_feignclient.model.User;
import com.user_service_calling_contact_with_eureka_circuitbreaker_feignclient.service.FeignClientContact;
import com.user_service_calling_contact_with_eureka_circuitbreaker_feignclient.service.UserService;
...
public class UserController {
	...
	@Autowired
	private FeignClientContact contactClient; // Inject the Feign client
	...
	public User getUser(@PathVariable("userId") Long userId) {
		...
		List<Contact> listContact = contactClient.getContactsOfUser(userId);
	...
	public List<User> getAllUsers() {
		...
		List<Contact> listContact = contactClient.getAllContacts();
